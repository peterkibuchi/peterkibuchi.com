...
<Aside type="tip" title="Try this focus exercise">
  Want a way to boost your attention and focus? Neuropsychologist Kim Willment
  of Harvard-affiliated Brigham and Women's Hospital suggests a single-task
  exercise like reading. "Read something for 30 minutes, setting a timer to go
  off every five minutes. When it goes off, ask yourself if your mind has
  wandered. If so, just refocus on what you're reading," she says. "By training
  your brain to monitor if your mind is wandering, you strengthen the monitoring
  process and the ability to maintain focus on a single task."
</Aside>
