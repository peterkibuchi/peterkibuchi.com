...
<Aside type="caution">
  This theme is updated frequently, and updating the theme may be a little bit
  complex. Please read the following breaking changes carefully.
</Aside>
  ...
  export const integ: IntegrationUserConfig = {
    links: {
      applyTip: [
        ...
        {
          name: "Avatar",
          val: "https://astro-pure.js.org/favicon/favicon.ico",
        },
...
- New format config file `src/site.config.ts`. There will be zod schema to validate the config file, and use of config will be changed to:
  ...
  import config, { siteConfig } from "@/site-config"; // [!code --]
  ```
