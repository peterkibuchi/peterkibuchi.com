...
<Aside type="tip">
  Astro has a great article teaching you setting up project: [Install and set up
  Astro #Use a theme or starter
...
3. Change the site favicon.
   ...
   <Aside type="tip">
     [Favicon.io](https://favicon.io/) is a great tool that can help you
